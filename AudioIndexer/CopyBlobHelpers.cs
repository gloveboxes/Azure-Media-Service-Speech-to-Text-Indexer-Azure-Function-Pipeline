...
namespace AudioIndexer
{
    class CopyBlobHelpers
    {
        CloudMediaContext _context;
        string _storageAccountName;
        string _storageAccountKey;
        CloudStorageAccount _destinationStorageAccount;
        public CopyBlobHelpers(CloudMediaContext context, string storageAccountName, string storageAccountKey, CloudStorageAccount destinationStorageAccount)
        {
            this._context = context;
            this._storageAccountName = storageAccountName;
            this._storageAccountKey = storageAccountKey;
            this._destinationStorageAccount = destinationStorageAccount;
        ...
        public async Task<IAsset> CreateAssetFromBlob(CloudBlockBlob blob, string assetName, TraceWriter log)
        {
        ...
        public async Task<IAsset> CreateAssetFromBlobAsync(CloudBlockBlob blob, string assetName, TraceWriter log)
        {
        ...
        //public async Task<IAsset> CreateAssetFromBlobMultipleFiles(CloudBlockBlob blob, string assetName, TraceWriter log, List<assetfileinJson> assetfilesAsset)
        //{
        //    IAsset newAsset = null;
        ...
        //public async Task<IAsset> CreateAssetFromBlobMultipleFilesAsync(CloudBlockBlob blob, string assetName, TraceWriter log, List<assetfileinJson> assetfilesAsset)
        //{
        //    //Get a reference to the storage account that is associated with the Media Services account. 
        //    StorageCredentials mediaServicesStorageCredentials =
        //        new StorageCredentials(_storageAccountName, _storageAccountKey);
